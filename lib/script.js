...
var Landscape = /*#__PURE__*/function () {
  ...
  _createClass(Landscape, [{
    ...
    value: function updateScore() {
      ...
      var player1Score = hits.map(function (hit) {
        return hit.points;
      }).reduce(function (partialsum, a) {
        return partialsum + a;
      }, 0);
      hits = this.nukedEmBases.filter(function (f) {
        return f.player == 1 && f.baseStatus == DESTROYED;
      });
      var player2Score = hits.map(function (hit) {
        return hit.points;
      }).reduce(function (partialsum, a) {
        return partialsum + a;
      }, 0);
    ...
    value: function drawExplosion() {
      ...
      ctx.drawImage(holeInGround, base.X - mushroomCloud.width / 2, base.Y, 50, 20);
    ...
    key: "drawMissMarkers",
    value: function drawMissMarkers(player1, player2) {
      ctx.fillStyle = "white";
...
var Background = /*#__PURE__*/function () {
  ...
  _createClass(Background, [{
    ...
    key: "hitAnimation",
    value: function hitAnimation(setUpScreen, player, opponent) {
      var r, g, b;
    ...
    key: "doGameOver",
    value: function doGameOver(player1, player2) {
      var text = "";

      if (player1.score == player2.score) {
        text = "GAME OVER, DRAW!!!";
      } else {
        var winner = player1.score > player2.score ? player1.playerName : player2.playerName;
...
var Missile = /*#__PURE__*/function () {
  ...
  _createClass(Missile, [{
    ...
    key: "convertMissilePosition",
    value: function convertMissilePosition(xycoord, value) {
...
var NukedEmGame = /*#__PURE__*/function () {
  function NukedEmGame() {
    ...
    _defineProperty(this, "player1", void 0);

    _defineProperty(this, "player2", void 0);
  ...
  _createClass(NukedEmGame, [{
    ...
    value: function doHit() {
      ...
      var playerName = base.player == 1 ? this.player2.playerName : this.player1.playerName;
      var opponentName = base.player == 1 ? this.player1.playerName : this.player2.playerName;
      this.showPowerAnglePad("none");
      this.landscape.drawExplosion();
      this.background.hitAnimation(function () {
        _this2.drawScreen();

        _this2.showPowerAnglePad("block");
      }, playerName, opponentName);
      this.landscape.drawBaseMissiles(this.player1.missiles, this.player2.missiles); // this.alternateTurn();
    }
  }, {
    key: "nextMissile",
    ...
    value: function drawScreen() {
      ...
      this.background.draw(this.landscape);
      this.landscape.drawBaseMissiles(this.player1.missileCount, this.player2.missileCount);
      ...
      if (missileStatus == ACTIVE) {
        ...
        switch (result) {
          case HIT:
            ...
            this.doHit();
            missileStatus = HIT; //this.newGame();
            // this.showPowerAnglePad("block");
        ...
        this.drawScreen(); // this.showPowerAnglePad("block");
